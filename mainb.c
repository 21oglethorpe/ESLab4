...
#define WAIT_COUNT              PWM_PERIOD/5   /* Interrupt wait counter */
...
static int TmrCtrSetupIntrSystem(INTC *IntcInstancePtr, XTmrCtr *InstancePtr,
						u16 DeviceId, u16 IntrId, XGpio *GpioInstancePtr);
...
static int DUTYCYCLE_DIVISOR  =  10    ;       /* Duty cycle Divisor */
...
static int TmrCtrSetupIntrSystem(INTC *IntcInstancePtr,
			XTmrCtr *TmrCtrInstancePtr, u16 DeviceId, u16 IntrId, XGpio *GpioInstancePtr)
{
	 int Status;
